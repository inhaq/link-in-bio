...
const HomePage = () => {
    return (
        <Flex alignItems={"center"} textAlign={"center"} flexDir={"column"} justifyContent={"center"} minH={"100vh"} background={"whatsapp.900"}>
            ...
            <Box as={"p"} fontSize={"16px"} mt={8} color={"khaki"} maxW={"300px"}>Create your own account just by adding to data.json file in <Link as={"a"} color={"teal.200"} href={"https://github.com/inhaq/link-in-bio"}> Repo</Link></Box>
        </Flex>
